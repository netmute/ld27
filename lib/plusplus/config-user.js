ig.module(
    ...
    .defines(function () {
        ...
        ig.CONFIG_USER.CHARACTER = {};
        ig.CONFIG_USER.CHARACTER.SPEED_X = 75;
        ig.CONFIG_USER.CHARACTER.SPEED_Y = 75;
        ig.CONFIG_USER.CHARACTER.MAX_VEL_GROUNDED_X = 50;
        ig.CONFIG_USER.CHARACTER.MAX_VEL_CLIMBING_Y = 35;
